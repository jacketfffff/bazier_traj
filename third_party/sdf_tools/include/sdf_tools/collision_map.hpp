...
#include </home/xcy/a_workspace/planner_ws/devel/include/sdf_tools/CollisionMap.h>
...
namespace sdf_tools
{
    ...
    public:
        ...
        inline CollisionMapGrid(const Eigen::Affine3d& origin_transform, const std::string& frame, const double resolution, const double x_size, const double y_size, const double z_size, const COLLISION_CELL& OOB_default_value) : initialized_(true)
        {
            frame_ = frame;
